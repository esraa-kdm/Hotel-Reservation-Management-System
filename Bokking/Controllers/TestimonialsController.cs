...
namespace Bokking.Controllers
{
    public class TestimonialsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Message,Isapproved,Userid,Hotelid")] Testimonial testimonial)
        {
            ...
            ViewData["Userid"] = new SelectList(_context.Customers, "Id", "Id", testimonial.Userid);
            return View(testimonial);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("Id,Message,Isapproved,Userid,Hotelid")] Testimonial testimonial)
        {
