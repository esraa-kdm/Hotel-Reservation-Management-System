...
namespace Bokking.Controllers
{
    public class ServicesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nameservice,Description,Price,HotelId")] Service service)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("Id,Nameservice,Description,Price,HotelId")] Service service)
        {
            if (id != service.Id)
            {
                return NotFound();
