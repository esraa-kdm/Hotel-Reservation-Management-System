...
namespace Bokking.Controllers
{
    public class UserLoginsController : Controller
    {
        ...
        {
            var modelContext = _context.UserLogins.Include(u => u.Customer);
        ...
        public async Task<IActionResult> Create([Bind("Id,Fname,Lname,Username,Password,Email,Role,Customerid")] UserLogin userLogin)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("Id,Fname,Lname,Username,Password,Email,Role,Customerid")] UserLogin userLogin)
        {
            if (id != userLogin.Id)
            {
                return NotFound();
